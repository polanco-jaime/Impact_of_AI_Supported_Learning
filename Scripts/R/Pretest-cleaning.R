...
# pretest <- read_sav("~/Downloads/survey_457438_spss.sav")

#### 1. Reading csv #### 
pretest <- read_csv("~/Downloads/results-survey457438 (34).csv")

pretest_st <- read_csv("~/Downloads/results-survey959811 (12).csv")
pretest$st =F
pretest_st$st = T
...
pretest$`Attitude and Motivation` =  (pretest$`AS01[SQ001]` + 
                pretest$`AS01[SQ002]`+   pretest$`AS01[SQ003]` + pretest$`AS01[SQ004]`+   pretest$`AS01[SQ005]` +
                pretest$`AS01[SQ006]`+   pretest$`AS01[SQ007]`  )/7
